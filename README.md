...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/Digulgasoft/SSH-WEB_2023/ubuinst.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/Digulgasoft/SSH-WEB_2023/sincpainel.sh)
```
