                        ...
                        <div class="auth-inner my-2">
                            ...
                            <div class="card mb-0">
								...
								<marquee behavior="scroll" onmouseout="this.start();" onmouseover="this.stop();"><b><FONT COLOR="#7367F0"><h5>📣 NOVIDADES AQUI !!!</h5></b></FONT></marquee>
                                        <h2 class="text-primary text-center"><a class="nav-link nav-link-style"><b>CONEXAO NET</b></h2></a>
                                    <br>
...
<a href="https://api.whatsapp.com/send?phone=5511958100839&text=Suporte" style="position:fixed;width:60px;height:60px;bottom:15px;right:15px;background: linear-gradient(118deg, #665bd9, rgba(220, 60, 239, 0.88));color:#FFF;border-radius:50px;text-align:center;font-size:30px;box-shadow: 1px 1px 2px #888;
  z-index:1000;" target="_blank">
<i style="margin-top:16px" class="fa fa-whatsapp" aria-hidden="true"></i>
</a>
</html>
