...
<head>
    ...
    <title>Conexao net 🚀 - PAINEL</title>
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
						...
						<a class="dropdown-item" href="/apps/"><i class="me-50" data-feather="download"></i>⏬ APPs</a>
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="home.php"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">Conexao net </h2>
                    </a></li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i class="text-primary" data-feather="settings"></i><span class="menu-title text-truncate" data-i18n="Configurações">CONFIGURAÇÕES</span></a>
                    <ul class="menu-content">
                        ...
                        <?php if ($usuario['tipo'] == "revenda") { ?>
							...
							<li><a href="/apps/"><i data-feather='download'></i><span class="menu-item" data-i18n="download">⏬ APPs</span></a>
                            </li>
                        <?php } ?>
                    </ul>
                </li>
        ...
        <center>
            <p class="clearfix blue-grey lighten-2 mb-0">
                <span class="center">
                    ...
                    <a class="text-bold-800 grey darken-2" href="https://api.whatsapp.com/send?phone=5511958100839&text=Suporte" target="_blank">Conexao net 🚀</a></span>
                </span>
