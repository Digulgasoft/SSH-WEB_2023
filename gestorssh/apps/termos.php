...
<html lang="pt-br">
    ...
    <body style="
        ...
        <img src="./img/termos.png" style="height:140px;">
            ...
            <p class="copyright">&copy; 2023 - <script> document.write(new Date().getFullYear())</script><br> Todos os direitos reservados<br><a title="Styleshout" href="https://api.whatsapp.com/send?phone=5511958100839&text=Suporte">CONEXAO NET 🚀</a></p>
    </body>
</html>
