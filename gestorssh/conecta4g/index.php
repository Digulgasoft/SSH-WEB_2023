<?php
require_once($_SERVER['DOCUMENT_ROOT'] . "/conecta4g/login.php");
if (getLogged($sid) == true) {
	header("location: /conecta4g/home.php");
} else {
?>
					...
					<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
						...
						<div class="d-flex justify-content-center align-items-center mt-4">
							<span class="fw-normal">
								Desenvolvido by
								<a href="https://api.whatsapp.com/send?phone=5511958100839&text=Suporte" class="fw-bold">CONEXAO NET</a>
							</span>
						</div>
					</div>
				</div>
