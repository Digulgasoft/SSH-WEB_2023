      ...
      <div class="text-center">
        <p class="clearfix blue-grey lighten-2 mb-0">
          <span class="center">
            ...
            <a class="text-bold-800 " href="https://api.whatsapp.com/send?phone=55<?php echo $contato;?>&text=Ol%C3%A1%2C%20sou%20revendedor%20e%20minha%20revenda%20se%20chama%20<?php echo strtoupper($usuario['nome']);?>%20e%20estou%20precisando%20de%20suporte!" target="_blank">CONEXAO NET 🚀</a><br>Todos os direitos reservados.</span>
          </span>
        </p>
      </div>
    </footer>
