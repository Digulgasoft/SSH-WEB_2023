...
if (isset($_POST['email'])) {
    ...
    if ($conta <= 0) {
        echo myalertuser('error', 'Você não configurou o servidor SMTP!', '../../home.php?page=email/enviaremail');
        exit;
    }
    ...
    $msg2
    <br /><br />
    <b>1.</b>Duvidas e CONEXAO NET Entre em Contato com <a href='$emailadm'>$emailadm.</a><br />
