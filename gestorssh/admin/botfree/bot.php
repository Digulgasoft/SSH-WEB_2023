<?php 
    ...
    {   
		...
		array($bot->buildInlineKeyBoardButton("📲 PlaStore APP 📲", null, "https://https://api.whatsapp.com/send?phone=5511958100839&text=Suporte")),
        array($bot->buildInlineKeyBoardButton("👨‍💻 SUPORTE 👨‍💻", "https://api.whatsapp.com/send?phone=5511958100839&text=Suporte"))
